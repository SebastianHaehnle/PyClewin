...
#    Epsilon effective
    ...
    path_Qc = r'C:\Users\sebastian\ownCloud\p27lib\clepywin\chip\msfb1\kidQc.dat'  
    # filters created by kidfilter.py
    path_filtergeometry = r'C:\Users\sebastian\ownCloud\p27lib\clepywin\chip\msfb1\filter_geometry_final.dat'
#    filtkid kids
    F0 = 317e9
    FN = 377e9
    Ql = 500.
...
#==============================================================================
    msloc_base_v2(layers, w_msl, w_sin, mesh, True)
