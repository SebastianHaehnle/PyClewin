...
#        kids =  mw.KIDSdesign(F0, FN, N, epsal, lal, epsms, lms, epsw, Ffilt, Nblind, Fgap = Fgap, delgap = delgap, lms_broad_c = lms_bb_c, lms_broad_stub = lms_bb_stub, lms_broad_mis = lms_bb_mis)
        kids = newKD.KIDSdesign(F0, FN, N, epsal, lal, Zcpw, epsms, lms, Zms, epsw, Ffilt, Nblind, Fgap = Fgap, delgap = delgap, lms_broad_c = lms_bb_c, lms_broad_stub = lms_bb_stub, lms_broad_mis = lms_bb_mis, lms_rturn = rturn*1e-6)
        kids.shuffle(mode = 2)
        # Qc to Lc calc
...
#==============================================================================
    ...
    #    cpwupgo(-1, r_ro, w_ro, s_ro, mesh)
        ...
        for jj in kidpos:
            msloc_readout_attachright(jj[2], l_kidQ_c[jj[3]], d_kidQ_c, w_wide, s_wide, w_ro, s_ro, r_ro, mesh, bridgefun, False)
        setmark('ro_topleft')
#
#
##==============================================================================
