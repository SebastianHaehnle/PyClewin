...
#    epsw = 7.77 #
    ...
    path_Qc = r'C:\Users\sebastian\ownCloud\p27lib\clepywin\chip\msloc1\kidQc.dat'  
    # filters created by kidfilter.py
    path_filtergeometry = r'C:\Users\sebastian\ownCloud\p27lib\clepywin\chip\msloc1\filter_geometry_final.dat'
#    filtkid kids
...
#==============================================================================
#     FILTER GEOMETRY TODO: correct lc_frac
#==============================================================================
...
#        
    for kid in kids:
        master.append([kid.i0, kid.modedict[kid.mode], kid.F, kidQ(), kid.lal*(w_hybrid-manVars.alLine), kid.Ffilt, filtQ()])
    ii = len(kids)
    master.append([ii, 'nbtin', purekids.custom[1].F, -1, 0, 0, 0])
    master.append([ii+1, 'al', purekids.custom[2].F, -1, purekids.custom[2].lhyb*w_hybrid-manVars.alLine, 0, 0])
    master.append([ii+2, 'mspure', purekids.custom[3].F, -1, 0, 0, 0])
    master.append([ii+3, 'nbtin', purekids.custom[5].F, -1, 0, 0, 0])
    master.append([ii+4, 'al', purekids.custom[6].F, -1, purekids.custom[6].lhyb*(w_hybrid-manVars.alLine), 0, 0])
    master.append([ii+5, 'mspure', purekids.custom[7].F, -1, 0, 0, 0])
