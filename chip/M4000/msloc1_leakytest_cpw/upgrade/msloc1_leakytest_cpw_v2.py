...
if __name__ == '__main__' :
    filename = 'msloc1_leakytest_cpw_v2.cif'
...
#    KID hybrid CPW
    w_hybrid = 2.0 + manVars.alLine #width of line
    s_hybrid = 2.4 + (manVars.nbtinSlot-manVars.alLine)/2. #width of slot
   
#   Bridge
    bridgefun = msloc_bridge_cpwonly 
...
#    Epsilon effective
    ...
    epsal = 4.66 # for GHz readout signal
    epsw = 7.77 #
    Zcpw = 85.0
    Zms = 102.0
#    filtkid kids
...
#    Antenna
    leaky_300to900_990um_directhybrid(-1j, kid, w_hybrid, s_hybrid, w_wide, s_wide, w_sin)
#   Tantalum Backside Mesh and free space    
...
#    write KID
    gomark('antenna')    
#    msloc_kid_v2(kid, w_hybrid, s_hybrid, w_wide, s_wide, w_msl, 0, 0, 0, mesh, w_sin, kidid = 0)
